...
class Home extends Component{
  ...
  finish() {
    ...
    console.log('latitude',this.state.polygons[0].coordinates[0].latitude);
    console.log('longitude',this.state.polygons[0].coordinates[0].longitude);
    console.log('Coordinates:', this.state.polygons.map(polygon => (
        polygon.coordinates
    )));
    console.log('map Poly latitude:', this.state.polygons.map(polygon => (
        polygon.coordinates.map(coordinate => (
          coordinate.latitude
        ))
    )));
    console.log('map Poly longitude:', this.state.polygons.map(polygon => (
        polygon.coordinates.map(coordinate => (
  ...
  render(){
    ...
    var navigationView = (
      <View style={{flex: 1, backgroundColor: '#fff'}}>
        <View style={{height: 220, backgroundColor: '#E43F3F',justifyContent: 'center',alignItems: 'center'}} >
